          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-bold mb-3 text-[rgb(37,108,250)]">Quick Assessment</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-bold mb-3 text-[rgb(37,108,250)]">Get Your Results</h3>
                <p className="text-black">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-black">Question {currentQuestion + 1} of {questions.length}</span>
            </div>
          ...
          <h4 className="text-xl font-semibold mb-6 text-black">{questions[currentQuestion].question}</h4>
          
          <div className="space-y-4">
            {questions[currentQuestion].options.map((option, index) => (
              <button
                key={index}
                className="w-full text-left p-4 border-2 border-gray-200 rounded-lg hover:border-[rgb(37,108,250)] hover:bg-blue-50 transition-colors text-black font-medium"
          ...
          <div className="space-y-6 mb-10">
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="font-semibold text-black">{results?.technology}%</span>
              </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="font-semibold text-black">Science</span>
                <span className="font-semibold text-black">{results?.science}%</span>
              </div>
              <div className="w-full bg-gray-200 h-4 rounded-full">
                <div 
                  className="bg-[rgb(37,108,250)] h-4 rounded-full" 
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="font-semibold text-black">Engineering</span>
                <span className="font-semibold text-black">{results?.engineering}%</span>
              </div>
              <div className="w-full bg-gray-200 h-4 rounded-full">
                <div 
                  className="bg-[rgb(37,108,250)] h-4 rounded-full" 
            ...
            <div>
              <div className="flex justify-between mb-2">
                <span className="font-semibold text-black">Mathematics</span>
                <span className="font-semibold text-black">{results?.mathematics}%</span>
              </div>
              <div className="w-full bg-gray-200 h-4 rounded-full">
                <div 
                  className="bg-[rgb(37,108,250)] h-4 rounded-full" 
